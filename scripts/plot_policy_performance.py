...
def main(cfg: Config):
    ...
    run_name = f"PPO_{cfg.scenario}_seed_{cfg.seed}"
    ...
    env = GraphWrapper(scenario=cfg.scenario, max_steps=cfg.episode_length, render_mode=None)
    ...
    sampler.sample_episodes(cfg.num_episodes, counter=None)
